...
% syms U1 U2 IL U0 I0 C1 C2 L R IS UT real
UT = 0.02569;
IS = 1e-9;
R = 1000;
L = 0.1;
...
equilibrium_point = solve(equations, variables, 'Real', true);
...
Ji_sym = subs(Ji_sym, [U0, I0], [U0_val, I0_val]);
